...
public class FunctionMain {
    public static void main(String[] args) {
        ...
        Monitor Monitor1 = new Monitor("Samsung C27F","Black" ,120, 1920 , 1080 ,75 , true);
        Monitor Monitor2 = new Monitor("LG U13D","White" ,100, 1920 , 1080 ,75 , false);
        ...
        //Now I made a change in the proprieties as requested in Lab1.Task1.Task1 Subtask2
